...
const Login = () => {
  ...
  const { user, googleSignIn, facebookSignIn, isloading, authError, signInEmailPassword } = useAuth();
    ...
    <div>
      <div className="container my-5">
        <div className="login-form shadow-lg p-3 mb-5 bg-body rounded w-50">
          ...
          {!isloading && <form onSubmit={handleSubmitLogin} className='login-design'>
            <Form.Label className="login-form-design"> Enter Email</Form.Label>
            <Form.Control placeholder="Enter email" className="bg-transparent" name='email' type='email' onBlur={handleOnBlur} />
            <Form.Label className="login-form-design">Enter password</Form.Label>
            <Form.Control placeholder="Enter password" className="bg-transparent" name='password' type='password' onBlur={handleOnBlur} />
